 ...
 * =============================================================================
 */
package com.haihun.pay.unionpay.sdk;
...
public class SDKConfig {
     ...
     * 从classpath路径下加载配置参数
     */
    public void loadPropertiesFromClassPath() throws Exception {
        ClassPathResource resource = new ClassPathResource(File.separator + FILE_NAME);
        LogUtil.writeLog("从classpath路径读取配置文件: " + FILE_NAME);
        if (resource.getFile().exists()) {
            ...
            LogUtil.writeErrorLog(resource.getPath() + FILE_NAME + "不存在,加载参数失败");
        }
    }
