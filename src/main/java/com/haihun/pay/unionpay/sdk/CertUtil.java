...
import static com.haihun.pay.unionpay.sdk.SDKUtil.*;
import static com.haihun.pay.unionpay.sdk.SDKConstants.*;
...
public class CertUtil {
    ...
    private static void initSdkConfig() {
        try {
            SDKConfig.getConfig().loadPropertiesFromClassPath();
        } catch (Exception e) {
            LogUtil.writeLog("初始化");
        }
    }
