...
public class RSA {
    ...
    public static Map<String, String> generateKeyPair(int keySize) {
        try {
            if (keySize < 512) throw new IllegalArgumentException("非法的参数！keySize :" + keySize);
     ...
     *
     * @param data            要加密的数据
     * @param base64PublicKey Base64加密后的公钥
     * @return 加密后的byte数组
     */
     ...
     *
     * @param data             解密数据
     * @param base64PrivateKey 经过Base64位加密的私钥
     * @return 解密后的报文
     */
     ...
     *
     * @param data             要加密的数据
     * @param base64PrivateKey Base64加密后的私钥
     * @return 加密后的byte数组
     */
     ...
     *
     * @param data            解密数据
     * @param base64PublicKey 经过Base64位加密的公钥
     * @return 解密后的报文
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str = RSA.encryptByPubkeyStr(aa, Constant.APP_PUBLIC_KEY);

        System.out.println("str : " + str);
        String source = RSA.decryptByPrivate(str, Constant.APP_PRIVATE_KEY);
